    ...
    return (
        <div className=''>
            <div className='flex items-center'>
                ...
                <h3 className='text-xl font-bold mb-5 absolute top-1 flex items-center justify-center w-full'>Finish this Ride</h3>
            </div>
            <div className='flex items-center w-full justify-between rounded-xl bg-slate-200 p-1 mb-1 mt-5'>
