    ...
    return (
        <div>
            ...
            className='flex active:border-2  active:border-black items-center justify-between p-2 rounded-xl mb-3'>
                ...
                <div className='m-2 w-2/3 text-center'>
                ...
                <h2 className='font-bold text-xl w-1/3 text-center'>₹ {props.fare.car}</h2>
            </div>
            <div 
            onClick={()=>{
                props.setConfirmedRidePanel(true)
            ...
            className='flex active:border-2 active:border-black items-center justify-between p-2 rounded-xl mb-3'>
                ...
                <div className='m-3 w-2/3 text-center'>
                ...
                <h2 className='font-bold text-xl w-1/3 text-center'>₹ {props.fare.moto}</h2>
            </div>
            <div
            onClick={() =>{
                props.setConfirmedRidePanel(true)
            ...
            className='flex active:border-2 active:border-black items-center justify-between p-2 rounded-xl mb-3'>
                ...
                <h2 className='font-bold text-xl w-1/3 text-center'>₹ {props.fare.auto}</h2>
            </div>
        </div>
    )
}
